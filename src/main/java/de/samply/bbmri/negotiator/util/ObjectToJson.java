...
public class ObjectToJson {
     ...
     */
    public String jsonTree(List<CollectionBiobankDTO> collections)
    {

        List<JsTreeJson> stats=new ArrayList<JsTreeJson>();
     ...
     */
    public List<JsTreeJson> setParentNode(List<CollectionBiobankDTO> collectionBiobankDTOS) {

        List<JsTreeJson> setParentNode=new ArrayList<JsTreeJson>();
     ...
     */
    public List<String> getNewList(List<CollectionBiobankDTO> collectionBiobankDTOS)
    {
     ...
     */
    public List<JsTreeJson> setChildNode(List<CollectionBiobankDTO> collectionBiobankDTOS) {

        List<JsTreeJson> setChildNode=new ArrayList<JsTreeJson>();
