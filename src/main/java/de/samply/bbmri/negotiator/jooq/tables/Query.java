...
public class Query extends TableImpl<QueryRecord> {
	...
	private static final long serialVersionUID = -1378010336;
	...
	/**
	 * The column <code>public.query.is_draft</code>.
	 */
	public final TableField<QueryRecord, Boolean> IS_DRAFT = createField("is_draft", org.jooq.impl.SQLDataType.BOOLEAN.defaulted(true), this, "");
