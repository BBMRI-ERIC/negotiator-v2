...
public class CommentRecord extends UpdatableRecordImpl<CommentRecord> implements Record7<Integer, Integer, Integer, Timestamp, String, Boolean, String> {
	 ...
	 */
	@Override
	public Row7<Integer, Integer, Integer, Timestamp, String, Boolean, String> fieldsRow() {
	 ...
	 */
	@Override
	public Row7<Integer, Integer, Integer, Timestamp, String, Boolean, String> valuesRow() {
	 ...
	 */
	@Override
	public CommentRecord values(Integer value1, Integer value2, Integer value3, Timestamp value4, String value5, Boolean value6, String value7) {
		value1(value1);
		value2(value2);
		value3(value3);
		value4(value4);
	 ...
	 */
	public CommentRecord(Integer id, Integer queryId, Integer personId, Timestamp commentTime, String text, Boolean attachment, String status) {
		super(Comment.COMMENT);
