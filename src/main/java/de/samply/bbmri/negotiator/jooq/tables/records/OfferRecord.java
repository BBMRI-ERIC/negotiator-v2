...
public class OfferRecord extends UpdatableRecordImpl<OfferRecord> implements Record7<Integer, Integer, Integer, Integer, Timestamp, String, String> {
	 ...
	 */
	@Override
	public OfferRecord values(Integer value1, Integer value2, Integer value3, Integer value4, Timestamp value5, String value6, String value7) {
		value1(value1);
		value2(value2);
		value3(value3);
		value4(value4);
	 ...
	 */
	public OfferRecord(Integer id, Integer queryId, Integer personId, Integer biobankInPrivateChat, Timestamp commentTime, String text, String status) {
		super(Offer.OFFER);
