...
public class OfferRecord extends UpdatableRecordImpl<OfferRecord> implements Record7<Integer, Integer, Integer, Integer, Timestamp, String, Integer> {

	private static final long serialVersionUID = -1988562376;
	...
	/**
	 * Setter for <code>public.offer.biobank_in_private_chat</code>. <<-- Missing in Code
	 */
	...
	/**
	 * Getter for <code>public.offer.biobank_in_private_chat</code>. <<-- Missing in Code
	 */
	 ...
	 */
	@Override
	public OfferRecord value7(Integer value) {
	 ...
	 */
	@Override
	public OfferRecord values(Integer value1, Integer value2, Integer value3, Integer value4, Timestamp value5, String value6, Integer value7) {
		value1(value1);
		value2(value2);
		value3(value3);
		value4(value4);
	 ...
	 */
	public OfferRecord(Integer id, Integer queryId, Integer personId, Integer offerFrom, Timestamp commentTime, String text, Integer biobankInPrivateChat) {
		super(Offer.OFFER);
		...
		setValue(5, text);
		setValue(6, biobankInPrivateChat);
	}
}
