...
public class QueryRecord extends UpdatableRecordImpl<QueryRecord> implements Record9<Integer, String, String, Timestamp, Integer, String, Integer, String, Boolean> {

	private static final long serialVersionUID = -911583711;
	 ...
	 */
	@Override
	public Row9<Integer, String, String, Timestamp, Integer, String, Integer, String, Boolean> fieldsRow() {
	 ...
	 */
	@Override
	public Row9<Integer, String, String, Timestamp, Integer, String, Integer, String, Boolean> valuesRow() {
	 ...
	 */
	@Override
	public QueryRecord values(Integer value1, String value2, String value3, Timestamp value4, Integer value5, String value6, Integer value7, String value8, Boolean value9) {
		value1(value1);
		value2(value2);
		value3(value3);
		value4(value4);
	 ...
	 */
	public QueryRecord(Integer id, String title, String text, Timestamp queryCreationTime, Integer researcherId, String jsonText, Integer numAttachments, String negotiatorToken, Boolean validQuery) {
		super(Query.QUERY);
