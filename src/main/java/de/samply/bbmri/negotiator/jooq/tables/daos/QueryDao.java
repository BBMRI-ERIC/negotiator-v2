...
public class QueryDao extends DAOImpl<QueryRecord, de.samply.bbmri.negotiator.jooq.tables.pojos.Query, Integer> {
	...
	/**
	 * Fetch records that have <code>is_draft IN (values)</code>
	 */
	public List<de.samply.bbmri.negotiator.jooq.tables.pojos.Query> fetchByIsDraft(Boolean... values) {
		return fetch(Query.QUERY.IS_DRAFT, values);
	}
}
