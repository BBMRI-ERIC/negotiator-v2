...
public class PersonRecord extends UpdatableRecordImpl<PersonRecord> implements Record9<Integer, String, String, String, byte[], Boolean, String, Boolean, Boolean> {
	 ...
	 */
	@Override
	public Row9<Integer, String, String, String, byte[], Boolean, String, Boolean, Boolean> fieldsRow() {
	 ...
	 */
	@Override
	public Row9<Integer, String, String, String, byte[], Boolean, String, Boolean, Boolean> valuesRow() {
	...
	public Field<Boolean> field9() {
		return Person.PERSON.IS_MODERATOR;
	}
	 ...
	 */
	@Override
	public PersonRecord values(Integer value1, String value2, String value3, String value4, byte[] value5, Boolean value6, String value7, Boolean value8, Boolean value9) {
		value1(value1);
		value2(value2);
		value3(value3);
		value4(value4);
	 ...
	 */
	public PersonRecord(Integer id, String authSubject, String authName, String authEmail, byte[] personImage, Boolean isAdmin, String organization, Boolean syncedDirectory, Boolean isModerator) {
		super(Person.PERSON);
