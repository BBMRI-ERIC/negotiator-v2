...
public class CommentRecord extends UpdatableRecordImpl<CommentRecord> implements Record5<Integer, Integer, Timestamp, Integer, String> {

	private static final long serialVersionUID = 621485522;
	 ...
	 */
	public CommentRecord(Integer id, Integer queryid, Timestamp timestamp, Integer personid, String text) {
		super(Comment.COMMENT);
