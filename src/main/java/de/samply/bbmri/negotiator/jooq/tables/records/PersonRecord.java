...
public class PersonRecord extends UpdatableRecordImpl<PersonRecord> implements Record7<Integer, String, String, String, byte[], Boolean, String> {

	private static final long serialVersionUID = -1971189707;
	 ...
	 */
	@Override
	public Row7<Integer, String, String, String, byte[], Boolean, String> fieldsRow() {
	 ...
	 */
	@Override
	public Row7<Integer, String, String, String, byte[], Boolean, String> valuesRow() {
	 ...
	 */
	@Override
	public PersonRecord values(Integer value1, String value2, String value3, String value4, byte[] value5, Boolean value6, String value7) {
		value1(value1);
		value2(value2);
		value3(value3);
		value4(value4);
	 ...
	 */
	public PersonRecord(Integer id, String authSubject, String authName, String authEmail, byte[] personImage, Boolean isAdmin, String organization) {
		super(Person.PERSON);
