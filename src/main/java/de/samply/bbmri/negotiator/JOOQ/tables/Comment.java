...
public class Comment extends TableImpl<CommentRecord> {
	...
	private static final long serialVersionUID = 1068855075;
	 ...
	 */
	public final TableField<CommentRecord, Integer> QUERYID = createField("queryId", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaulted(true), this, "Foreign key which exists as primary key in the query table. ");
	 ...
	 */
	public final TableField<CommentRecord, Integer> PERSONID = createField("personId", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaulted(true), this, "Foreign key which exists as primary key in the person table. describes the person who made the comment.");
