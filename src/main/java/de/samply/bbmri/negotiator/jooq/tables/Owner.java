...
public class Owner extends TableImpl<OwnerRecord> {
	...
	private static final long serialVersionUID = -979028686;
	 ...
	 */
	public final TableField<OwnerRecord, Integer> LOCATIONID = createField("locationId", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "This foreign key is the primary key of person table");
