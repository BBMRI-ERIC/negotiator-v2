...
public class OfferRecord extends UpdatableRecordImpl<OfferRecord> implements Record7<Integer, Integer, Integer, Integer, Timestamp, String, Boolean> {

	private static final long serialVersionUID = 1519981624;
	...
	/**
	 * Setter for <code>public.offer.attachment</code>.
	 */
	...
	/**
	 * Getter for <code>public.offer.attachment</code>.
	 */
	 ...
	 */
	@Override
	public Row7<Integer, Integer, Integer, Integer, Timestamp, String, Boolean> fieldsRow() {
	 ...
	 */
	@Override
	public Row7<Integer, Integer, Integer, Integer, Timestamp, String, Boolean> valuesRow() {
	 ...
	 */
	@Override
	public OfferRecord value7(Boolean value) {
		setAttachment(value);
		return this;
	}
	 ...
	 */
	@Override
	public OfferRecord values(Integer value1, Integer value2, Integer value3, Integer value4, Timestamp value5, String value6, Boolean value7) {
		value1(value1);
		value2(value2);
		value3(value3);
		value4(value4);
	 ...
	 */
	public OfferRecord(Integer id, Integer queryId, Integer personId, Integer biobankInPrivateChat, Timestamp commentTime, String text, Boolean attachment) {
		super(Offer.OFFER);
