...
public class FlaggedQueryRecord extends UpdatableRecordImpl<FlaggedQueryRecord> implements Record3<Integer, Integer, Flag> {

	private static final long serialVersionUID = 298755867;
	...
	/**
	 * Setter for <code>public.flagged_query.flag</code>. The flag of the comment. One of "ARCHIVED", "IGNORED" or "STARRED"
	 */
	...
	/**
	 * Getter for <code>public.flagged_query.flag</code>. The flag of the comment. One of "ARCHIVED", "IGNORED" or "STARRED"
	 */
	public Flag getFlag() {
		return (Flag) getValue(2);
	}
	 ...
	 */
	@Override
	public Row3<Integer, Integer, Flag> fieldsRow() {
	 ...
	 */
	@Override
	public Row3<Integer, Integer, Flag> valuesRow() {
	 ...
	 */
	@Override
	public FlaggedQueryRecord value3(Flag value) {
		setFlag(value);
		return this;
	}
	 ...
	 */
	@Override
	public FlaggedQueryRecord values(Integer value1, Integer value2, Flag value3) {
		value1(value1);
		value2(value2);
		value3(value3);
		return this;
	 ...
	 */
	public FlaggedQueryRecord(Integer queryId, Integer personId, Flag flag) {
		super(FlaggedQuery.FLAGGED_QUERY);
