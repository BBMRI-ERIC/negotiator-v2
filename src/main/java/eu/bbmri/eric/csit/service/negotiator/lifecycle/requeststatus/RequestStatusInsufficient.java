...
public class RequestStatusInsufficient implements RequestStatus {

    private String status = null;
    private final String statusType = LifeCycleRequestStatusType.INSUFFICIENT;
    private final String statusText = "The request specification is insufficient.";
    ...
    public RequestStatusInsufficient(CollectionRequestStatusDTO collectionRequestStatusDTO) {
