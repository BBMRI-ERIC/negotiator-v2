...
public class QueryCollectionRecord extends UpdatableRecordImpl<QueryCollectionRecord> implements Record5<Integer, Integer, Boolean, Integer, Integer> {

	private static final long serialVersionUID = -1846028502;
	 ...
	 */
	@Override
	public Row5<Integer, Integer, Boolean, Integer, Integer> fieldsRow() {
	 ...
	 */
	@Override
	public Row5<Integer, Integer, Boolean, Integer, Integer> valuesRow() {
	 ...
	 */
	@Override
	public QueryCollectionRecord values(Integer value1, Integer value2, Boolean value3, Integer value4, Integer value5) {
		value1(value1);
		value2(value2);
		value3(value3);
		value4(value4);
	 ...
	 */
	public QueryCollectionRecord(Integer queryId, Integer collectionId, Boolean expectConnectorResult, Integer donors, Integer samples) {
		super(QueryCollection.QUERY_COLLECTION);
