...
public class Taggedquery extends TableImpl<TaggedqueryRecord> {
	...
	private static final long serialVersionUID = 360615232;
	 ...
	 */
	public final TableField<TaggedqueryRecord, Integer> QUERYID = createField("queryId", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "This column along with tagId will make the primary key. Its also a foreign key here, taken from query table");
	 ...
	 */
	public final TableField<TaggedqueryRecord, Integer> TAGID = createField("tagId", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "This column along with the Queryid column will make the primary key. Its also a foreign key here, taken from \"tag\" table");
	...
	public List<UniqueKey<TaggedqueryRecord>> getKeys() {
		return Arrays.<UniqueKey<TaggedqueryRecord>>asList(Keys.TAGGEDQUERY_PKEY);
	}
