...
public class QueryRecord extends UpdatableRecordImpl<QueryRecord> implements Record8<Integer, String, String, Timestamp, Integer, String, Integer, String> {
	 ...
	 */
	@Override
	public Row8<Integer, String, String, Timestamp, Integer, String, Integer, String> fieldsRow() {
	 ...
	 */
	@Override
	public Row8<Integer, String, String, Timestamp, Integer, String, Integer, String> valuesRow() {
	 ...
	 */
	@Override
	public QueryRecord values(Integer value1, String value2, String value3, Timestamp value4, Integer value5, String value6, Integer value7, String value8) {
		value1(value1);
		value2(value2);
		value3(value3);
		value4(value4);
	 ...
	 */
	public QueryRecord(Integer id, String title, String text, Timestamp queryCreationTime, Integer researcherId, String jsonText, Integer numAttachments, String negotiatorToken) {
		super(Query.QUERY);
