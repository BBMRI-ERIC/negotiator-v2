...
public class Offer extends TableImpl<OfferRecord> {
	...
	private static final long serialVersionUID = 1615433171;
	...
	/**
	 * The column <code>public.offer.biobank_in_private_chat</code>. <<-- Missing in Code
	 */
	public final TableField<OfferRecord, Integer> BIOBANK_IN_PRIVATE_CHAT = createField("biobank_in_private_chat", org.jooq.impl.SQLDataType.INTEGER, this, "<<-- Missing in Code");
