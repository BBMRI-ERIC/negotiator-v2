...
public class QueryRecord extends UpdatableRecordImpl<QueryRecord> implements Record6<Integer, String, String, Timestamp, Integer, String> {

	private static final long serialVersionUID = -1449294938;
	 ...
	 */
	@Override
	public QueryRecord values(Integer value1, String value2, String value3, Timestamp value4, Integer value5, String value6) {
		value1(value1);
		value2(value2);
		value3(value3);
		value4(value4);
	 ...
	 */
	public QueryRecord(Integer id, String title, String text, Timestamp queryCreationTime, Integer researcherId, String jsonText) {
		super(Query.QUERY);
