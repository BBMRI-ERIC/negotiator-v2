...
public class CommentRecord extends UpdatableRecordImpl<CommentRecord> implements Record7<Integer, Integer, Integer, Timestamp, String, Boolean, Boolean> {

	private static final long serialVersionUID = 1770193435;
	...
	/**
	 * Setter for <code>public.comment.published</code>.
	 */
	...
	/**
	 * Getter for <code>public.comment.published</code>.
	 */
	 ...
	 */
	@Override
	public Row7<Integer, Integer, Integer, Timestamp, String, Boolean, Boolean> fieldsRow() {
	 ...
	 */
	@Override
	public Row7<Integer, Integer, Integer, Timestamp, String, Boolean, Boolean> valuesRow() {
	...
	public Field<Boolean> field7() {
		return Comment.COMMENT.PUBLISHED;
	}
	 ...
	 */
	@Override
	public CommentRecord value7(Boolean value) {
		setPublished(value);
		return this;
	}
	 ...
	 */
	@Override
	public CommentRecord values(Integer value1, Integer value2, Integer value3, Timestamp value4, String value5, Boolean value6, Boolean value7) {
		value1(value1);
		value2(value2);
		value3(value3);
		value4(value4);
	 ...
	 */
	public CommentRecord(Integer id, Integer queryId, Integer personId, Timestamp commentTime, String text, Boolean attachment, Boolean published) {
		super(Comment.COMMENT);
