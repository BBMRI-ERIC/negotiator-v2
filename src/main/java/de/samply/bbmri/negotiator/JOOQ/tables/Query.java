...
public class Query extends TableImpl<QueryRecord> {
	...
	private static final long serialVersionUID = 2115347588;
	 ...
	 */
	public final TableField<QueryRecord, String> TEXT = createField("text", org.jooq.impl.SQLDataType.VARCHAR, this, "text of query");
	 ...
	 */
	public final TableField<QueryRecord, Integer> RESEARCHERID = createField("researcherId", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaulted(true), this, "Foreign key. Exists as primary key in the researcher table(which takes it in turn from the person table)");
	...
	public List<UniqueKey<QueryRecord>> getKeys() {
		return Arrays.<UniqueKey<QueryRecord>>asList(Keys.QUERY_PKEY, Keys.QUERY_RESEARCHERID_KEY);
	}
