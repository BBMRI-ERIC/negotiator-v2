...
public class PersonRecord extends UpdatableRecordImpl<PersonRecord> implements Record7<Integer, PersonType, String, String, String, byte[], Integer> {
	...
	private static final long serialVersionUID = 1384983778;
	...
	/**
	 * Setter for <code>public.person.person_type</code>. describes wether the person is researcher or owner - one of the the two child classes. 
	 */
	...
	/**
	 * Getter for <code>public.person.person_type</code>. describes wether the person is researcher or owner - one of the the two child classes. 
	 */
	...
	public Field<PersonType> field2() {
		return Person.PERSON.PERSON_TYPE;
	}
