...
public class PersonRecord extends UpdatableRecordImpl<PersonRecord> implements Record6<Integer, String, String, String, byte[], Boolean> {

	private static final long serialVersionUID = -1975478045;
	 ...
	 */
	@Override
	public Row6<Integer, String, String, String, byte[], Boolean> fieldsRow() {
	 ...
	 */
	@Override
	public Row6<Integer, String, String, String, byte[], Boolean> valuesRow() {
	 ...
	 */
	@Override
	public PersonRecord values(Integer value1, String value2, String value3, String value4, byte[] value5, Boolean value6) {
		value1(value1);
		value2(value2);
		value3(value3);
		value4(value4);
	 ...
	 */
	public PersonRecord(Integer id, String authSubject, String authName, String authEmail, byte[] personImage, Boolean isAdmin) {
		super(Person.PERSON);
