...
public class QueryRecord extends UpdatableRecordImpl<QueryRecord> implements Record6<Integer, String, String, Timestamp, Integer, Object> {

	private static final long serialVersionUID = 152655992;
	 ...
	 */
	public void setJsonText(Object value) {
		setValue(5, value);
	}
	 ...
	 */
	@Override
	public Row6<Integer, String, String, Timestamp, Integer, Object> fieldsRow() {
	 ...
	 */
	@Override
	public Row6<Integer, String, String, Timestamp, Integer, Object> valuesRow() {
	 ...
	 */
	@Override
	public QueryRecord value6(Object value) {
		setJsonText(value);
		return this;
	}
	 ...
	 */
	@Override
	public QueryRecord values(Integer value1, String value2, String value3, Timestamp value4, Integer value5, Object value6) {
		value1(value1);
		value2(value2);
		value3(value3);
		value4(value4);
	 ...
	 */
	public QueryRecord(Integer id, String title, String text, Timestamp queryCreationTime, Integer researcherId, Object jsonText) {
		super(Query.QUERY);
