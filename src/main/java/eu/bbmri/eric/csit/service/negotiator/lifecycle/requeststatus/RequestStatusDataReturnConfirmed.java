...
public class RequestStatusDataReturnConfirmed implements RequestStatus {
    ...
    public RequestStatusDataReturnConfirmed(CollectionRequestStatusDTO collectionRequestStatusDTO) {
